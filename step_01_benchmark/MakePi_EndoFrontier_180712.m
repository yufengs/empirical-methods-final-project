...
global alpha0 alpha1 alpha2 alpha3 detrend_P0 detrend_P1 detrend_Q0 detrend_Q1 t x thai mc q0 Qj p T Pi statespace;
...
Thai_data = [zeros(1,63), ones(1,20)]'; % Thai-flood dummy (=1 from 2011Q4, or 64th quarter)
...
FTmap = [1; 2; 7; 9; 11; 14; 15; 17; 19; 24; 27; 31; 35; 43; 48; 52; 56; 62; 78; 63;...
        63; 63; 63; 63; 63; 63; 63; 63; 63; 63; 63; 63];   

% 2018/7/10 demand estimates with detrended (log_Q & log_P), original (log_X), and "Z & Thai_flood as IV"
...
statespace = zeros(1,1+Type); % Grid of states, each row of which = (frontier, n1, n2, n3, n4)
...
for t = 1:T 
    ...
    fprintf('\n Calculating equilibrium profits in period %2.0f...    ',t); 
    tic
...
save MakePi_EndoFrontier_180712.mat;
